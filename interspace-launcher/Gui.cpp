...
void Gui::initLayout()
{
        ...
        connect(leftArrowButton, SIGNAL(clicked()), newsFeed, SLOT(decrementNewsItem()));
        ...
        connect(rightArrowButton, SIGNAL(clicked()), newsFeed, SLOT(incrementNewsItem()));
